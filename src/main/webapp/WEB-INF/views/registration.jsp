...
<br><br>
   ...
   <form:checkbox path="quota" value="Muktijudda" id="quotaA"/> Option A<br>
   <form:checkbox path="quota" value="Adibasi quota" id="quotaB"/> Option B<br>
   <form:checkbox path="quota" value="" id="potibondhi quota"/> Option C<br>
